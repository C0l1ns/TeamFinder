        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BGameName = table.Column<string>(type: "text", nullable: false),
                    Difficulty = table.Column<byte>(type: "tinyint unsigned", maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardGames", x => x.BGameId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LobbyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    LobbyName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
                    About = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
